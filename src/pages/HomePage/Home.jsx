        ...
        <div className="home-right">
          <div className="content">
            ...
            <p className="description">
              ...
              University with a finance background. I enjoy building
              applications using Python, Java, HTML, CSS, JavaScript, and React,
              combining technical skills with analytical problem-solving.
            </p>
            ...
            <div className="action-buttons">
              ...
              <button
                className="action-btn projects-btn"
